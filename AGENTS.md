...
10. **Comentarios únicamente en Español:** Documenta el *por qué* de la lógica compleja bloque por bloque. No uses comentarios redundantes que solo describan *qué* hace el código.
